    ...
    void Update()
    {
        ...
        //    {
           ...
           // if (Input.GetKeyUp(KeyCode.JoystickButton0) || Input.GetMouseButtonUp(0))
            //if ((InputDevices.GetDeviceAtXRNode(XRNode.LeftHand).TryGetFeatureValue(CommonUsages.triggerButton, out triggerIsDone) && triggerIsDone) || (InputDevices.GetDeviceAtXRNode(XRNode.RightHand).TryGetFeatureValue(CommonUsages.triggerButton, out triggerIsDone) && triggerIsDone) || Input.GetMouseButtonUp(0))
            //{
            //    if (lastHit != null)
            //    {
            //        lastHit.DOKill();
